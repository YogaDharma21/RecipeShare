                        ...
                        <div className="list-items-container flex flex-col mt-[26px]">
                            <div className="list flex gap-[14px]">
                                ...
                                <p className="leading-8 pb-[30px]">
                                    Siapkan telur rebus dicampur dengan mentega
                                    rendah kalori
                                </p>
                            </div>
                            <div className="list flex gap-[14px]">
                                ...
                                <p className="leading-8 pb-[30px]">
                                    Panaskan minyak dengan api stabil agar tidak
                                    gosong nanti dagingnya
                                </p>
                            </div>
                            <div className="list flex gap-[14px]">
                                <div className="flex relative">
                            ...
                            <div className="list flex gap-[14px]">
                                ...
                                <p className="leading-8 pb-[30px]">
                                    Grill daging sapi dengan keadaan frozen dan
                                    berikan sea salts
                                </p>
                            </div>
                            <div className="list flex gap-[14px]">
                                ...
                                <p className="leading-8 pb-[30px]">
                                    Gabungkan satu per satu ketika masih panas
                                    jadi lebih melekat
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        <div className="flex flex-col gap-5">
                            <div className="review-card flex flex-col pb-5 border-b border-[#E7E7E7] gap-3">
                                <p className="leading-8">
                                    Hemat uang jadinya gaperlu beli burger di
                                    luar, udah bisa masak sendiri hehehe
                                </p>
                                <div className="flex items-center justify-between gap-3">
                                    <div className="flex items-center gap-3">
                                        <div className="flex shrink-0 w-[50px] h-[50px] rounded-full overflow-hidden">
                            ...
                            <div className="review-card flex flex-col pb-5 border-b border-[#E7E7E7] gap-3">
                                <p className="leading-8">
                                    Recipe paling enak menurut gue karena anak
                                    gak pernah bosan makan ini terus setiap
                                    harinya, thank you banget ya shay...
                                </p>
                                <div className="flex items-center justify-between gap-3">
                                    <div className="flex items-center gap-3">
                                        <div className="flex shrink-0 w-[50px] h-[50px] rounded-full overflow-hidden">
