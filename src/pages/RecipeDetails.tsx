...
export default function RecipeDetails() {
    ...
    return (
        <>
            ...
            <section
                id="Description"
                className="flex flex-col gap-4 px-5 mt-[30px]"
            >
                <div className="flex flex-col gap-2">
                    <h2 className="font-bold">About</h2>
                    <p className="leading-8">
                        Burger tebal asal kota inkopad ini sangat membuat lapar
                        dan sehat untuk tubuh kita terutama ketika sedang
                        bulking pada masa otot terbaru setelah olahraga.
                    </p>
                </div>
            ...
            <section id="Details" className="mt-[30px] mb-28">
                    ...
                    >
                        ...
                        >
                            <SwiperSlide className="!w-fit pb-[26px]">
                                <button
                                    className={`flex items-center gap-[10px] py-3 px-4 rounded-full font-semibold text-white transition-all duration-300 ${
                                        activeTab === "ingredients"
                                            ? "bg-[#FF4C1C] shadow-[0_10px_20px_0_#FF4C1C80]"
                                            : "bg-black"
                                    }`}
                                    id="ingredients-tab"
                            ...
                            <div className="list-items-container flex flex-col mt-[26px]">
                                <div className="list flex gap-[14px]">
                                    ...
                                    <p className="leading-8 pb-[30px]">
                                        Siapkan telur rebus dicampur dengan
                                ...
                                <div className="list flex gap-[14px]">
                                    ...
                                    <p className="leading-8 pb-[30px]">
                                        Panaskan minyak dengan api stabil agar
                                        tidak gosong nanti dagingnya
                                    </p>
                                </div>
                                <div className="list flex gap-[14px]">
                                    <div className="flex relative">
                                    ...
                                    <p className="leading-8 pb-[30px]">
                                        Roti disajikan tanpa wijen agar rasanya
                                        tidak bertabrakan salada
                                    </p>
                                </div>
                                <div className="list flex gap-[14px]">
                                    <div className="flex relative">
                                    ...
                                    <p className="leading-8 pb-[30px]">
                                        Grill daging sapi dengan keadaan frozen
                                        dan berikan sea salts
                                    </p>
                                </div>
                                <div className="list flex gap-[14px]">
                                    <div className="flex relative">
                                    ...
                                    <p className="leading-8 pb-[30px]">
                                        Gabungkan satu per satu ketika masih
                                        panas jadi lebih melekat
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex flex-col gap-5">
                                <div className="review-card flex flex-col pb-5 border-b border-[#E7E7E7] gap-3">
                                    <p className="leading-8">
                                        Hemat uang jadinya gaperlu beli burger
                                        di luar, udah bisa masak sendiri hehehe
                                    </p>
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-3">
                                            <div className="flex shrink-0 w-[50px] h-[50px] rounded-full overflow-hidden">
                                ...
                                <div className="review-card flex flex-col pb-5 border-b border-[#E7E7E7] gap-3">
                                    <p className="leading-8">
                                        Recipe paling enak menurut gue karena
                                        anak gak pernah bosan makan ini terus
                                        setiap harinya, thank you banget ya
                                        shay...
                                    </p>
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-3">
